...
public class AliPayUtil {
     ...
     * 调用支付宝支付
     */
    public static String aliPay(Context context, UserPaymentEntity userRecharge){
        String privateKey = userRecharge.getPrivateKey();
        ...
        String orderInfo = getOrderInfo("订单号:" + userRecharge.getSerialNumber(),
                Constant.IdString.AliPayCompany, userRecharge.getSettlementMoney(), userRecharge.getSerialNumber(),
                userRecharge.getNotifyUrl());
        Log.e("aaa",orderInfo);
