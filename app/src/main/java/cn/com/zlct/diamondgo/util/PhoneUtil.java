...
public class PhoneUtil {
     ...
     * 更新购物车上的红点
     */
    public static void upCartDot(Application application, CircleView circleView){
    ...
    public static UserInfoEntity getUserInfo(Context context){
        SharedPreferences userInfoShare = context.getSharedPreferences("userInfo", context.MODE_PRIVATE);
        String userInfo = userInfoShare.getString("UserInfo", null);
        if (userInfo != null) {
            try {
                userInfo = DesUtil.decrypt(userInfo, DesUtil.LOCAL_KEY);
